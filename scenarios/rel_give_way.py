...
class RelGiveWay(BaseScenario):
    def make_world(self, batch_dim: int, device: torch.device, **kwargs):
        ...
        self.agent_radius = kwargs.get("agent_radius", 0.12)
    ...
    def spawn_map(self, world: World):
        ...
        self.passage_length = 0.4 # used to be 0.4 w agent radius of 0.16
        self.passage_width = 0.48 #0.48  # box obstacle length
